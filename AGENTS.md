...
1. Implement a correct rules engine before training.
2. Add focused unit tests for every rule and edge case.
3. Build simple baseline agents before neural/RL agents.
4. Keep generated run outputs, checkpoints, and large artifacts out of git.
5. Preserve docs when design decisions change.
